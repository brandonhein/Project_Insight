    ...
    public partial class BRADS_UI : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                File.AppendAllText(Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + "\\Insight\\log.txt", DateTime.Now + " - BRADS - WeatherAPI - Success" + Environment.NewLine);
            }
            catch
            {
                label4.Text = "API Status: ERROR";
                label5.Text = "API Error";
                File.AppendAllText(Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + "\\Insight\\log.txt", DateTime.Now + " - BRADS - WeatherAPI - ERROR " + Environment.NewLine);
            }
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            File.AppendAllText(Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + "\\Insight\\log.txt", DateTime.Now + " - BRADS - PictureTaken - CAM:" + comboBox1.SelectedIndex + Environment.NewLine);
        }
