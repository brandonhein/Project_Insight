...
namespace ApplicationScheduler
{
    public partial class Form1 : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
                                            ...
                                            || label1.Text == "211500" || label1.Text == "221500" || label1.Text == "231500"))
            {
                try
                {
                    ...
                    File.AppendAllText(Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + "\\Insight\\log.txt", DateTime.Now + " - PingService - Ping/Internet - " + pingReply.RoundtripTime.ToString() + "ms" + Environment.NewLine);
                }
                ...
                catch (System.Net.NetworkInformation.PingException)
                {
                    try
                    {
                        ...
                        File.AppendAllText(Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + "\\Insight\\log.txt", DateTime.Now + " - PingService - Ping/Router - " + pingReply.RoundtripTime.ToString() + "ms" + Environment.NewLine);
                        button3_Click(sender, e);//run the Macro to reset router
                    }
                    catch (System.Net.NetworkInformation.PingException)
                    {
                        File.AppendAllText(Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + "\\Insight\\log.txt", DateTime.Now + " - PingService - Ping/No Connection - null - " + Environment.NewLine);
                    }
                }
            }
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            File.AppendAllText(Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + "\\Insight\\log.txt", DateTime.Now + " - PingService - Service ON - Confirm" + Environment.NewLine);
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            File.AppendAllText(Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + "\\Insight\\log.txt", DateTime.Now + " - PingService - Service OFF - Confirm" + Environment.NewLine);
        }
